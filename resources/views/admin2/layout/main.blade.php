...
<head>
    ...
    <!-- Favicon icon-->
    <link rel="shortcut icon" type="image/png" href="{{ asset('landing/assets/img/logo-login.png') }}">

    <!-- Core Css -->
    {{-- <link rel="stylesheet" href="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/css/styles.css"> --}}
...
<body>
    {{-- <div class="toast toast-onload align-items-center text-bg-primary border-0" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-body hstack align-items-start gap-6">
            ...
            <div>
                <h5 class="text-white fs-3 mb-1">Welcome to Flexy</h5>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            @include('admin2.partials.aside-vertical')
    ...
    {{-- <script src="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/js/vendor.min.js"></script>
    <!-- Import Js Files -->
    <script src="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script src="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/libs/simplebar/dist/simplebar.min.js"></script>
    <script src="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/js/theme/app.init.js"></script>
    <script src="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/js/theme/theme.js"></script>
    <script src="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/js/theme/app.min.js"></script>
    <script src="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/js/theme/sidebarmenu.js"></script> --}}
    ...
    <script src="https://cdn.jsdelivr.net/npm/iconify-icon@1.0.8/dist/iconify-icon.min.js"></script>
    {{-- <script src="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/libs/apexcharts/dist/apexcharts.min.js"></script>
    <script src="https://bootstrapdemos.wrappixel.com/flexy/dist/assets/js/dashboards/dashboard.js"></script> --}}
    ...
    @if (Session::get('mustsuperadmin'))
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'You must be superadmin to access this page',
                showConfirmButton: false,
                timer: 1500,
            })
        </script>
