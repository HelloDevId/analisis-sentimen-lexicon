...
<body>
                ...
                <div class="row">
                    <div class="col-xl-7 col-xxl-8">
                        ...
                        <div class="d-none d-xl-flex align-items-center justify-content-center h-n80">
                            <img src="{{ asset('admin2/assets/images/backgrounds/login-security.svg') }}"
                                alt="flexy-img" class="img-fluid" width="500">
                                ...
                                <div class="row">
                                    <div class="col-6 mb-2 mb-sm-0">
                                        <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8"
                                            ...
                                            <img src="{{ asset('admin2/assets/images/svgs/google-icon.svg') }}"
                                                alt="flexy-img" class="img-fluid me-2" width="18" height="18">
                                    ...
                                    <div class="col-6">
                                        <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8"
                                            href="javascript:void(0)" role="button">
                                            <img src="{{ asset('admin2/assets/images/svgs/facebook-icon.svg') }}"
                                                alt="flexy-img" class="img-fluid me-2" width="18" height="18">
    ...
    <!-- solar icons -->
    <script src="{{ asset('admin2/npm/iconify-icon%401.0.8/dist/iconify-icon.min.js') }}"></script>
