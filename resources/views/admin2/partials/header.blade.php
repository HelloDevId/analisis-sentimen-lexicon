                                                    ...
                                                    <div class="position-relative">
                                                        <a href="app-chat.html" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('admin2/assets/images/svgs/icon-dd-chat.svg') }}" alt="flexy-img" class="img-fluid" width="24" height="24">
                                                            </div>
                                                            <div>
                                                        ...
                                                        <a href="app-invoice.html" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('admin2/assets/images/svgs/icon-dd-invoice.svg') }}" alt="flexy-img" class="img-fluid" width="24" height="24">
                                                            </div>
                                                            <div>
                                                        ...
                                                        <a href="app-contact2.html" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('admin2/assets/images/svgs/icon-dd-mobile.svg') }}" alt="flexy-img" class="img-fluid" width="24" height="24">
                                                            </div>
                                                            <div>
                                                                <h6 class="mb-1 fw-semibold fs-3">
                                                                    Contact Application
                                                        ...
                                                        <a href="app-email.html" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('admin2/assets/images/svgs/icon-dd-message-box.svg') }}" alt="flexy-img" class="img-fluid" width="24" height="24">
                                                            </div>
                                                            <div>
                                                ...
                                                <div class="col-6">
                                                    <div class="position-relative">
                                                        <a href="page-user-profile.html" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('admin2/assets/images/svgs/icon-dd-cart.svg') }}" alt="flexy-img" class="img-fluid" width="24" height="24">
                                                            </div>
                                                            <div>
                                                                <h6 class="mb-1 fw-semibold fs-3">
                                                                    User Profile
                                                        ...
                                                        <a href="app-calendar.html" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('admin2/assets/images/svgs/icon-dd-date.svg') }}" alt="flexy-img" class="img-fluid" width="24" height="24">
                                                            </div>
                                                            <div>
                                                                <h6 class="mb-1 fw-semibold fs-3">
                                                                    Calendar App
                                                        ...
                                                        <a href="app-contact.html" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('admin2/assets/images/svgs/icon-dd-lifebuoy.svg') }}" alt="flexy-img" class="img-fluid" width="24" height="24">
                                                            </div>
                                                            <div>
                                                                <h6 class="mb-1 fw-semibold fs-3">
                                                                    Contact List Table
                                                        ...
                                                        <a href="app-notes.html" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('admin2/assets/images/svgs/icon-dd-application.svg') }}" alt="flexy-img" class="img-fluid" width="24" height="24">
                                                            </div>
                                                            <div>
                                                                <h6 class="mb-1 fw-semibold fs-3">
                                                                    Notes Application
                    ...
                    <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                        ...
                        {{-- <li class="nav-item nav-icon-hover-bg rounded-circle dropdown">
                            <a class="nav-link" href="javascript:void(0)" id="drop2" aria-expanded="false">
                                <img src="{{ asset('admin2/assets/images/svgs/icon-flag-en.svg') }}" alt="flexy-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20">
                            </a>
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                <div class="message-body">
                                    ...
                                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                        <div class="position-relative">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-flag-cn.svg') }}" alt="flexy-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20">
                                        </div>
                                        <p class="mb-0 fs-3">中国人 (Chinese)</p>
                                    </a>
                                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                        <div class="position-relative">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-flag-fr.svg') }}" alt="flexy-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20">
                                        </div>
                                        <p class="mb-0 fs-3">français (French)</p>
                                    </a>
                                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                        <div class="position-relative">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-flag-sa.svg') }}" alt="flexy-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20">
                                        </div>
                            ...
                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                ...
                                <div class="message-body" data-simplebar="">
                                    <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-2.jpg') }}" alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                    ...
                                    <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-3.jpg') }}" alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                    ...
                                    <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-4.jpg') }}" alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                    ...
                                    <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-5.jpg') }}" alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                    ...
                                    <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-6.jpg') }}" alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                    ...
                                    <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-7.jpg') }}" alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                            <h6 class="mb-0 fs-4 lh-base">Roman Joined the Team!</h6>
                                            <span class="fs-3 d-block text-body-secondary">Congratulate him</span>
                            ...
                            <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <div class="user-profile-img">
                                        <img src="{{ asset('admin2/assets/images/profile/user-1.jpg') }}"
                                            class="rounded-circle" width="35" height="35" alt="flexy-img">
                                    </div>
                                </div>
                            </a>
                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="profile-dropdown position-relative" data-simplebar="">
                                    ...
                                    <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                        <img src="{{ asset('admin2/assets/images/profile/user-1.jpg') }}"
                                            class="rounded-circle" width="80" height="80" alt="flexy-img">
                                        <div class="ms-3">
                                    ...
                                    {{-- <div class="message-body">
                                        <a href="page-user-profile.html" class="py-8 px-7 mt-8 d-flex align-items-center">
                                            <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                                                <img src="{{ asset('admin2/assets/images/svgs/icon-account.svg') }}" alt="flexy-img" width="24" height="24">
                                            </span>
                                        ...
                                        <a href="app-email.html" class="py-8 px-7 d-flex align-items-center">
                                            <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                                                <img src="{{ asset('admin2/assets/images/svgs/icon-inbox.svg') }}" alt="flexy-img" width="24" height="24">
                                            </span>
                                            <div class="w-100 ps-3">
                                        ...
                                        <a href="app-notes.html" class="py-8 px-7 d-flex align-items-center">
                                            <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                                                <img src="{{ asset('admin2/assets/images/svgs/icon-tasks.svg') }}" alt="flexy-img" width="24" height="24">
                                            </span>
                                            <div class="w-100 ps-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="m-n4 unlimited-img">
                                                        <img src="{{ asset('admin2/assets/images/backgrounds/unlimited-bg.png') }}" alt="flexy-img" class="w-100">
                                                    </div>
                                                </div>
                                            </div>
                                        </div> --}}
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar"
            ...
            <nav class="sidebar-nav scroll-sidebar">
                <div class="offcanvas-header justify-content-between">
                    <img src="{{ asset('admin2/assets/images/logos/favicon.png') }}" alt="flexy-img" class="img-fluid">
                            ...
                            <ul aria-expanded="false" class="collapse first-level my-3">
                                <li class="sidebar-item py-2">
                                    <a href="app-chat.html" class="d-flex align-items-center">
                                        <div
                                            ...
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-dd-chat.svg') }}"
                                                alt="flexy-img" class="img-fluid" width="24" height="24">
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="app-invoice.html" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-dd-invoice.svg') }}"
                                                alt="flexy-img" class="img-fluid" width="24" height="24">
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="admin2/main/app-cotact.html" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-dd-mobile.svg') }}"
                                                alt="flexy-img" class="img-fluid" width="24" height="24">
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="app-email.html" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-dd-message-box.svg') }}"
                                                alt="flexy-img" class="img-fluid" width="24" height="24">
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="page-user-profile.html" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-dd-cart.svg') }}"
                                                alt="flexy-img" class="img-fluid" width="24" height="24">
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="app-calendar.html" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-dd-date.svg') }}"
                                                alt="flexy-img" class="img-fluid" width="24" height="24">
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="app-contact2.html" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-dd-lifebuoy.svg') }}"
                                                alt="flexy-img" class="img-fluid" width="24" height="24">
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="app-notes.html" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-dd-application.svg') }}"
                                                alt="flexy-img" class="img-fluid" width="24" height="24">
                                        </div>
                                        <div>
    ...
    <div class="app-header with-horizontal">
        <nav class="navbar navbar-expand-xl container-fluid p-0">
                                                    ...
                                                    <div class="position-relative">
                                                        <a href="app-chat.html"
                                                            ...
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('admin2/assets/images/svgs/icon-dd-chat.svg') }}"
                                                                    alt="flexy-img" class="img-fluid" width="24"
                                                                    height="24">
                                                            </div>
                                                            <div>
                                                                <h6 class="mb-1 fw-semibold fs-3">
            ...
            <div class="d-block d-xl-none">
                <a href="index.html" class="text-nowrap nav-link">
                    <img src="{{ asset('admin2/assets/images/logos/dark-logo.svg') }}" width="180"
                        alt="flexy-img">
                </a>
            </div>
            <a class="navbar-toggler nav-icon-hover-bg rounded-circle p-0 mx-0 border-0" href="javascript:void(0)"
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <div class="d-flex align-items-center justify-content-between px-0 px-xl-8">
                    ...
                    <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                        ...
                        <li class="nav-item nav-icon-hover-bg rounded-circle dropdown">
                            <a class="nav-link" href="javascript:void(0)" id="drop2" aria-expanded="false">
                                <img src="{{ asset('admin2/assets/images/svgs/icon-flag-en.svg') }}" alt="flexy-img"
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="message-body">
                                    <a href="javascript:void(0)"
                                        ...
                                        <div class="position-relative">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-flag-en.svg') }}"
                                                alt="flexy-img" width="20px" height="20px"
                                    ...
                                    <a href="javascript:void(0)"
                                        class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                        <div class="position-relative">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-flag-cn.svg') }}"
                                                alt="flexy-img" width="20px" height="20px"
                                                class="rounded-circle object-fit-cover round-20">
                                        </div>
                                        <p class="mb-0 fs-3">中国人 (Chinese)</p>
                                    ...
                                    <a href="javascript:void(0)"
                                        class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                        <div class="position-relative">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-flag-fr.svg') }}"
                                                alt="flexy-img" width="20px" height="20px"
                                                class="rounded-circle object-fit-cover round-20">
                                        </div>
                                        <p class="mb-0 fs-3">français (French)</p>
                                    ...
                                    <a href="javascript:void(0)"
                                        class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                        <div class="position-relative">
                                            <img src="{{ asset('admin2/assets/images/svgs/icon-flag-sa.svg') }}"
                                                alt="flexy-img" width="20px" height="20px"
                                                class="rounded-circle object-fit-cover round-20">
                                        </div>
                                        <p class="mb-0 fs-3">عربي (Arabic)</p>
                            ...
                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="message-body" data-simplebar="">
                                    <a href="javascript:void(0)"
                                        ...
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-2.jpg') }}"
                                    ...
                                    <a href="javascript:void(0)"
                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-3.jpg') }}"
                                                alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                            <h6 class="mb-0 fs-4 lh-base">New message</h6>
                                            <span class="fs-3 d-block text-body-secondary">Salma sent you new
                                                message</span>
                                        </div>
                                    </a>
                                    <a href="javascript:void(0)"
                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-4.jpg') }}"
                                                alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                            <h6 class="mb-0 fs-4 lh-base">Bianca sent payment</h6>
                                    ...
                                    <a href="javascript:void(0)"
                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-5.jpg') }}"
                                                alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                            <h6 class="mb-0 fs-4 lh-base">Jolly completed tasks</h6>
                                    ...
                                    <a href="javascript:void(0)"
                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-6.jpg') }}"
                                                alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                            <h6 class="mb-0 fs-4 lh-base">John received payment</h6>
                                            <span class="fs-3 d-block text-body-secondary">$230 deducted from
                                                account</span>
                                        </div>
                                    </a>
                                    <a href="javascript:void(0)"
                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                        <span class="me-3">
                                            <img src="{{ asset('admin2/assets/images/profile/user-7.jpg') }}"
                                                alt="user" class="rounded-circle" width="48" height="48">
                                        </span>
                                        <div class="w-100">
                                            <h6 class="mb-0 fs-4 lh-base">Roman Joined the Team!</h6>
